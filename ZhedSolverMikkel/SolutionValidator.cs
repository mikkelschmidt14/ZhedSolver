...
namespace ZhedSolverMikkel
{
    ...
    {
        bool ValidateSolution(IBoard board, HashSet<SolutionStep> solutionSteps);
    }
    ...
    public class SolutionValidator : ISolutionValidator
    {
        ...
        private HashSet<SolutionStep> _solutionSteps;

        public bool ValidateSolution(IBoard board, HashSet<SolutionStep> solutionSteps)
        {
